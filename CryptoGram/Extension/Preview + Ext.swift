...
extension StatisticModel {
    static let previewStat1 = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.34)
    static let previewStat2 = StatisticModel(title: "Total Volume", value: "$1.23Tr")
    static let previewStat3 = StatisticModel(title: "Portfolio value", value: "$50.4k", percentageChange: -12.34)
}
